    ...
    <div className="overflow-hidden">
      ...
      <section className="relative h-dvh min-h-[600px]">
        ...
        <Image
          ...
          alt="Terrazza e green del Golf della Montecchia"
          fill
          priority
          sizes="100vw"
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="tel:+393346774483" className="mt-1 block text-sm font-medium text-warm-white hover:text-green-light transition-colors">
                  +39 334 677 4483
                </a>
                <a href="mailto:lamontecchiagreen@gmail.com" className="text-xs text-warm-white/60 hover:text-green-light transition-colors">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-green-dark p-8 text-warm-white shadow-xl md:p-12">
            ...
            <div className="relative grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
              ...
              <div className="flex flex-col gap-3 sm:flex-row md:flex-col md:min-w-[200px]">
                <Link
                  href="https://wa.me/393346774483?text=Ciao%20La%20Montecchia%20Green%2C%20vorrei%20parlare%20di%20un%20evento."
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href="mailto:eventimontecchia@golfmontecchia.it"
                  className="flex items-center justify-center gap-2 rounded-xl border border-warm-white/25 bg-warm-white/10 px-6 py-3.5 text-sm font-semibold text-warm-white backdrop-blur-sm transition-colors hover:bg-warm-white/20"
                >
                  Email
                </a>
