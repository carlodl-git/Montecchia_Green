...
export const metadata: Metadata = {
  ...
  description:
    'Lounge bar, restaurant & events at Golf della Montecchia, 10 min from Padua. Open every day, Sunset Cup on Wednesdays, evening bistrot Thu-Fri-Sat. Book on WhatsApp.',
  openGraph: {
    type: 'website',
    locale: 'en_GB',
    url: `${CONTACT.site}/en`,
