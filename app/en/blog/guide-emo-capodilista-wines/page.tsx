...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.lamontecchiagreen.it/en/blog/guide-emo-capodilista-wines',
    languages: {
      'it': 'https://www.lamontecchiagreen.it/blog/guida-vini-emo-capodilista',
      'en': 'https://www.lamontecchiagreen.it/en/blog/guide-emo-capodilista-wines',
    },
  },
};
    ...
    <div>
      ...
      <section className="relative min-h-[52vh]">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 md:py-20">
          ...
          <Reveal delayMs={80}>
            <p className="mt-4 text-sm text-text-mid/70">April 8, 2026</p>
          </Reveal>
        </div>
      </section>
