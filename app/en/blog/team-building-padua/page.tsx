...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.lamontecchiagreen.it/en/blog/team-building-padua',
    languages: {
      'it': 'https://www.lamontecchiagreen.it/blog/team-building-padova',
      'en': 'https://www.lamontecchiagreen.it/en/blog/team-building-padua',
    },
  },
};
    ...
    <div>
      ...
      <section className="relative min-h-[52vh]">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 md:py-20">
          ...
          <Reveal delayMs={80}>
            <p className="mt-4 text-sm text-text-mid/70">March 28, 2026</p>
          </Reveal>
        </div>
      </section>
