...
// Max 5 FAQ visibili+schema per PAA targeting più preciso.
const ristoranteFaq = [
  {
...
Prenotazioni: +39 049 805 8464`}
        ...
        <div className="mt-8 rounded-2xl border border-green-dark/10 bg-warm-white p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-text-mid">
            ...
            o consulta il nostro{' '}
            <Link href="/menu" className="font-semibold text-green-dark underline decoration-green-mid/40 underline-offset-2 hover:decoration-green-dark">
              menu stagionale completo
            </Link>.
          </p>
        </div>
        ...
        <SchemaOrg variant="breadcrumb" breadcrumbItems={[
          ...
          { name: 'Ristorante', url: `${CONTACT.site}/ristorante` },
        ]} />
