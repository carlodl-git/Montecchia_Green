...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.lamontecchiagreen.it/matrimoni',
      ...
      <section className="mx-auto max-w-6xl px-4 py-14">
        ...
        <SchemaOrg
          ...
          breadcrumbItems={[
            ...
            { name: 'Matrimoni', url: 'https://www.lamontecchiagreen.it/matrimoni' },
          ]}
        />
          ...
          <div className="grid gap-4">
            <Reveal>
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-start">
                ...
                >
                  <Link
                    href="https://wa.me/393346774483?text=Ciao%20La%20Montecchia%20Green%2C%20vorrei%20informazioni%20per%20un%20matrimonio."
                    target="_blank"
                    rel="noreferrer"
                  >
                    WhatsApp
