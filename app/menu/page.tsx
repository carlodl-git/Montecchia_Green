...
const menuFaq = [
  { question: 'Il menu cambia con le stagioni?', answer: 'Sì, il menu de La Montecchia Green cambia ogni stagione. Lo chef adatta i piatti in base alla disponibilità di ingredienti locali e stagionali, incluse le verdure dell\'orto proprio.' },
  ...
  { question: 'Quali sono i prezzi indicativi del menu?', answer: 'I primi vanno da 12 a 18 euro, i piatti dalla piastra da 14 a 30 euro, le insalate da 12 a 15 euro e i dessert da 6 a 8 euro. Il coperto è di 2 euro.' },
  ...
  { question: 'Avete menu vegetariani o vegani?', answer: 'Sì, sono disponibili su richiesta prodotti vegani. Molti piatti del menu includono opzioni a base vegetale, come l\'insalata Stagionale Cotta e Cruda, le Patatas Bravas e la Pasta e Fasoi.' },
  { question: 'Come posso vedere il menu aggiornato?', answer: 'Il menu è consultabile su questa pagina e viene aggiornato regolarmente. Per ulteriori informazioni, contattaci via WhatsApp al +39 334 677 4483 o scrivi a lamontecchiagreen@gmail.com.' },
];
